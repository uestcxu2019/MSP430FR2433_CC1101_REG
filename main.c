...
*************************************************************************************/
	//定义用于发送数据数组
//	uint8_t Tx_Buffer[5]={0x59,0x02,0x32,0x04,0x22};   	//定义要发送的数据，用于闪灯指令
	uint8_t Tx_ON[5]={0x59,0x02,0x32,0x04,0x25};   		//定义要发送的数据，用于开灯指令
	uint8_t Tx_OFF[5]={0x59,0x02,0x32,0x05,0x26};   	//定义要发送的数据，用于关灯指令
